  ...
  const handleCashOut = async (pinData: PinValues) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.warning("Cash In Unsuccessful");
      }
    } catch (error: any) {
  ...
  return (
    <div className="pb-10">
      ...
      >
        ...
        <motion.h1 className="text-2xl font-bold mb-2 pt-2">Cash In</motion.h1>
        <motion.p className="text-lg mb-4">
          Need to add funds? Top up instantly via bank transfer, mobile money,
